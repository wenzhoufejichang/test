				...
				<meta name="format-detection" content="telephone=no">
					...
					<link rel="stylesheet" type="text/css"
						...
						<script type="text/javascript"
							src="/js/jquery-1.5.1.min.js?v=20160713"></script>
...
<body>
	...
	<div class="cartMain">
		<div class="cartThead" style="margin: 50px 0px 50px 50px;">
			...
			<div class="cartJsuan">
				<input type="button" class="goshop"
					onclick="window.history.back();return false;" value="返回" /> <input
					type="button" class="jiesuan youxuan"
					onclick="location.href='http://localhost:8090/cart/cart.html'"
					value="去购物车结算" />
			</div>
		</div>
